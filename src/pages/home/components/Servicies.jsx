...
const Servicies = () => {
  ...
  return (
    <div className=" dark:bg-zinc-950 container mx-auto  w-full h-full min-h-screen ">
      <div className="mx-auto w-full flex items-center justify-center flex-col gap-5">
        ...
        <p className="text-center w-full text-gray-900 dark:text-white/80 text-2xl md:w-1/2">
