    ...
    <motion.div 
      ...
      <motion.div 
        ...
        <motion.h1 
          ...
          className="text-2xl md:text-3xl font-bold text-white/90 tracking-tight">Link Building</motion.h1>
        <motion.p 
          initial={{ y: 20, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          transition={{ delay: 0.3 }}
          className="text-white/70 leading-relaxed text-sm md:text-base">
          Strengthen your backlink profile and improve your search engine
          rankings with our two powerful link building strategies: Digital PR
          and 3-way link exchange. Our team will help you acquire high-quality,
          relevant links from authoritative websites in your industry.
        </motion.p>
      </motion.div>
      <motion.div 
        initial={{ x: 50 }}
